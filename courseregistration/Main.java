...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            courses = loadCoursesFromCSV("courseregistration\\MyUniversityCourses.csv");
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (values.length >= 6) { // Ensure there are enough data points
                    Course course = new Course(values[0], values[1], Integer.parseInt(values[2]), values[3],
    ...
    private static void saveState(List<Course> courses, List<Student> students) throws IOException {
        // First, ensure that the enrolledStudents list in each course is not null
    ...
    private static void handleAdminActions(Scanner scanner, Admin admin, List<Course> courses, List<Student> students)
            throws IOException {
        int choice;
        do {
            System.out.println("\n--- Admin Menu ---");
            ...
            switch (choice) {
                case 1:
                    // Create a new course
                    System.out.println(
                            "Enter course details (Name, ID, Max Students, Instructor, Section Number, Location):");
                    ...
                    if (details.length == 6) {
                        ...
                        Course newCourse = new Course(courseName, courseId, maxStudents, instructor, sectionNumber,
                                location);
                ...
                case 3:
                    ...
                    if (courseToEdit != null) {
                        ...
                        System.out.print(
                                "Enter new max number of students (Current: " + courseToEdit.getMaxStudents() + "): ");
                        int newMaxStudents = Integer.parseInt(scanner.nextLine().trim());
                        System.out.print(
                                "Enter new instructor name (Current: " + courseToEdit.getCourseInstructor() + "): ");
                        String newInstructor = scanner.nextLine().trim();
                        System.out
                                .print("Enter new section number (Current: " + courseToEdit.getSectionNumber() + "): ");
                ...
                case 4:
                    ...
                    if (courseToDisplay != null) {
                        ...
                        // If you're maintaining a list of student names or IDs within the course, you
                        // can display them here as well
                    } else {
                ...
                case 5:
                    ...
                    if (studentInfo.length == 4 && courseToRegister != null) {
                        if (courseToRegister.getCurrentNumStudents() < courseToRegister.getMaxStudents()) {
                            Student newStudent = new Student(studentInfo[0].trim(), studentInfo[1].trim(),
                                    studentInfo[2].trim(), studentInfo[3].trim());
                            courseToRegister.addStudent(newStudent); // Add the student to the course's enrolled
                                                                     // students list
                            if (students == null) {
                ...
                case 10:
                    ...
                    if (foundStudent.isPresent()) {
                        ...
                        if (enrolledCourses.isEmpty()) {
                            ...
                            enrolledCourses.forEach(course -> System.out
                                    .println(course.getCourseName() + " - " + course.getCourseId()));
                        }
                    } else {
                ...
                case 11:
                    ...
                    courses.forEach(course -> System.out
                            .println(course.getCourseName() + " - Enrolled: " + course.getCurrentNumStudents()));
                    break;
                case 12:
            ...
            switch (choice) {
                    ...
                    if (inputParts.length == 2) {
                        ...
                        Optional<Course> courseToRegister = courses.stream()
                                .filter(course -> course.getCourseId().equals(courseId)
                                        && String.valueOf(course.getSectionNumber()).equals(section))
                                .findFirst();
                        if (courseToRegister.isPresent()) {
                            // Registration logic here
                            student.registerForCourse(courseToRegister.get(), student);
                ...
                case 5:
                    ...
                    if (student.getEnrolledCourses().size() > 0) {
                        ...
                        System.out.println("Please register for some :)");
                    }
